...
class RosCamera(Camera, backend="ros"):
    ...
    def __init__(self, backend) -> None:
        ...
        print("/camera/color/camera_info received")
        ...
        print("waiting for /camera/aligned_depth_to_color/image_raw")
        rospy.wait_for_message(depth_topic_name, Image, timeout=1)
        print("/camera/aligned_depth_to_color/image_raw received")
